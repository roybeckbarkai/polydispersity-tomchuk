    ...
    if mode == 'Sphere':
        if method == 'Tomchuk':
            ...
            tenor = analyze_tenor_saxs_2d(
                ...
                use_m3=bool(analysis_settings.get('tenor_use_m3', False)),
                use_g3=bool(analysis_settings.get('tenor_use_g3', False)),
                ridge_lambda_scale=float(analysis_settings.get('tenor_ridge_lambda_scale', 1e-6)),
